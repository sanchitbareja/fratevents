...
function getClubInfo(hostid){
	...
	$.ajax({
		...
		if(returnData['success']){
			...
			newModal = '<div id="club_'+returnData['id']+'" class="reveal-modal"><div id="clubInfoHeader"><img id="clubInfoHeaderImage" src="'+returnData['image']+'" /><h1 id="clubInfoHeaderText">'+returnData['name']+'</h1></div><div id="clubInfoBody"><b><i>Founded in '+returnData['founded']+'</i></b><p><b><i>Type of Organization: '+returnData["typeOfOrganization"]+'</i></b></p><p>'+returnData['description']+'</p></div><a class="close-reveal-modal">&#215;</a></div>';
