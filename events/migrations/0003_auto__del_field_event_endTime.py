...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('events_event', 'endTime')


    def backwards(self, orm):
        # Adding field 'Event.endTime'
        db.add_column('events_event', 'endTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 4, 0, 0)),
                      keep_default=False)
