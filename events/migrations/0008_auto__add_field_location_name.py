...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_location', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Test', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.name'
        db.delete_column('events_location', 'name')
    ...
    models = {
        ...
        'events.event': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '175', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
