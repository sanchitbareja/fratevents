...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('events_event', 'where')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Event.where'
        raise RuntimeError("Cannot reverse this migration. 'Event.where' and its values cannot be restored.")
