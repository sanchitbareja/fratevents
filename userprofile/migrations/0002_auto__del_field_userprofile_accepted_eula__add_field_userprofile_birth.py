...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('userprofile_userprofile', 'accepted_eula')

        # Adding field 'UserProfile.birthday'
        db.add_column('userprofile_userprofile', 'birthday',
    ...
    def backwards(self, orm):
        ...
        db.add_column('userprofile_userprofile', 'accepted_eula',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserProfile.birthday'
        db.delete_column('userprofile_userprofile', 'birthday')
